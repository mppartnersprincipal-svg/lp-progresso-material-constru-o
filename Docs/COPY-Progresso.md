# COPY — Landing Page Progresso Materiais de Construção

**Versão:** 1.0 · **Idioma:** pt-BR · **Documento complementar ao PRD**

---

## Guia de uso deste documento

- Tudo marcado como `[CONFIRMAR: ...]` é uma lacuna real de informação. **Não preencher com suposição.** Ou o cliente confirma, ou o trecho sai da página. Uma promessa falsa numa LP de material de construção gera atrito no balcão e avaliação negativa no Google.
- Contagens de caracteres dos `<title>` e `<meta description>` já estão dentro do limite. Ao editar, recontar.
- Textos de introdução são **únicos por página** de propósito. Não reaproveitar entre categorias — conteúdo duplicado dilui todas as páginas envolvidas.

## Voz da marca

Direta, prática, de quem trabalha com obra. Frases curtas. Sem adjetivo publicitário vazio ("excelência", "soluções inovadoras", "líder de mercado"). O cliente quer saber três coisas: **tem?**, **onde fica?**, **quanto custa?** A copy responde nessa ordem.

## Dados fixos (NAP — usar sempre idêntico)

```
Nome:      Progresso Materiais de Construção
Endereço:  Av. Graça Aranha — Jardim Nova Era, Aparecida de Goiânia - GO, 74916-379
Telefone:  (62) 98517-2398
WhatsApp:  https://wa.me/5562985172398
Horário:   Segunda a sexta: 7h30 às 18h
           Sábado: 7h30 às 13h
           Domingo: 7h30 às 12h
```

**Frase de horário para uso em CTA e anúncios:** *Aberto todos os dias, inclusive domingo.*

---

# 0. HOME — `/`

**Title (54):** `Progresso Materiais de Construção | Aparecida de Goiânia`

**Meta description (152):** `Loja completa de material de construção na Av. Graça Aranha, Aparecida de Goiânia. Elétrica, hidráulica, tintas, ferragens e cimento. Aberto todo dia.`
...
**CTA primário:** Fazer orçamento no WhatsApp
**CTA secundário:** Ligar: (62) 98517-2398

### Barra de confiança (faixa horizontal)

`Loja física no Jardim Nova Era` · `Aberto todos os dias` · `Orçamento pelo WhatsApp` · `(62) 98517-2398`
...
| Card | Texto do card |
|---|---|
| Material Elétrico | Fios, disjuntores, quadros, tomadas e iluminação |
| Material Hidráulico | Tubos, conexões, registros e caixas d'água |
| Tintas e Pintura | Tintas, massas, texturas, rolos e pincéis |
| Impermeabilizantes | Mantas, argamassas poliméricas e selantes |
| Metais e Louças Sanitárias | Vasos, cubas, torneiras, chuveiros e acabamentos |
| Ferramentas | Manuais, elétricas e equipamentos de proteção |
| Ferragens | Parafusos, buchas, dobradiças, fechaduras e cadeados |
| Areia e Brita Ensacada | Areia, brita, pedrisco e pó de pedra em sacos |
| Cimento e Argamassas | Cimento, argamassa colante, rejunte e cal |
| Portas e Janelas | Portas, batentes, janelas e guarnições |

### Por que a Progresso

**H2:** Por que comprar aqui

**1. Resolve a obra inteira numa parada**
Da fundação ao acabamento. Você não perde a manhã indo em três lojas para juntar cimento, fio e tinta.

**2. Aberto quando você tem tempo**
Segunda a sábado até de tarde e domingo pela manhã. Descobriu no fim de semana que faltou material? A loja está aberta.

**3. Orçamento pelo WhatsApp**
Manda a lista, a foto da peça ou o nome do produto. A gente confere o estoque e responde com o preço.

**4. Atendimento de quem conhece obra**
`[CONFIRMAR: há quantos anos a loja opera? Se houver tempo de casa relevante, usar aqui — "X anos atendendo obras da região" é o argumento de autoridade mais forte disponível.]`

### Onde estamos

**H2:** Onde estamos

Av. Graça Aranha — Jardim Nova Era, Aparecida de Goiânia - GO, 74916-379
`[CONFIRMAR: número/quadra/lote para completar o endereço]`
...
**Onde fica a Progresso Materiais de Construção?**
...
**A Progresso abre aos domingos?**
Sim. Aos domingos atendemos das 7h30 às 12h.
...
`[CONFIRMAR: Pix, dinheiro, cartão de débito/crédito, parcelamento, faturado para construtora]`

**Vocês entregam?**
`[CONFIRMAR: faz entrega? Qual raio? Frete grátis acima de qual valor? Se não houver entrega, remover esta pergunta em vez de dar resposta evasiva.]`

### CTA final

**H2:** Precisa de material hoje?
Manda a lista no WhatsApp que a gente confere o estoque e passa o preço.
**Botão:** Fazer orçamento no WhatsApp
...
# 2. MATERIAL HIDRÁULICO — `/material-hidraulico`

**Title (55):** `Material Hidráulico em Aparecida de Goiânia | Progresso`
**Meta description (151):** `Tubos e conexões PVC, registros, caixas d'água e vedantes em Aparecida de Goiânia. Loja física no Jardim Nova Era, aberta inclusive aos domingos.`
**H1:** Material hidráulico em Aparecida de Goiânia
**Keyword principal:** material hidráulico aparecida de goiânia

**Hero subtítulo:** Tubos, conexões, registros e caixas d'água para água fria, esgoto e reparo emergencial.

**Mensagem do WhatsApp:** `Olá! Preciso de material hidráulico. Vocês têm:`
...
- `[CONFIRMAR: trabalha com CPVC / PPR para água quente?]`
- `[CONFIRMAR: vende bombas d'água e pressurizadores?]`

### Diferenciais

**Aberto no fim de semana** — Vazamento no domingo de manhã tem solução a poucos minutos.
**Conexão certa na primeira viagem** — Traga a peça velha ou mande a foto: identificamos a bitola e o tipo.
**Hidráulica e acabamento juntos** — Do tubo dentro da parede ao metal do banheiro, tudo na mesma loja.

### FAQ

**Qual a diferença entre PVC soldável e roscável?**
...
**Vocês têm peça para reparo de vazamento?**
...
**Que tamanho de caixa d'água eu preciso?**
...
**Correlatas:** Metais e Louças Sanitárias · Ferramentas

---

# 3. TINTAS E PINTURA — `/tintas-e-pintura`

**Title (52):** `Loja de Tintas em Aparecida de Goiânia | Progresso`
**Meta description (150):** `Tinta acrílica, látex, esmalte, massa corrida, textura, rolos e pincéis em Aparecida de Goiânia. Loja física no Jardim Nova Era. Orçamento no WhatsApp.`
**H1:** Tintas e material de pintura em Aparecida de Goiânia
**Keyword principal:** loja de tintas aparecida de goiânia

**Hero subtítulo:** Tinta, massa, textura e todo o acessório para pintar parede, teto, ferro e madeira.

**Mensagem do WhatsApp:** `Olá! Preciso de tinta. Vou pintar:`
...
- `[CONFIRMAR: quais marcas de tinta a loja trabalha? Marca é keyword de alto volume — vale página ou seção própria.]`
- `[CONFIRMAR: a loja faz máquina de tingimento / cores sob encomenda?]`

### Diferenciais

**Cálculo de quantidade** — Diga a metragem e quantas demãos: ajudamos a estimar quantos galões ou latas comprar.
**Do preparo ao acabamento** — Massa, selador, lixa, tinta e rolo na mesma compra.
**Aberto no fim de semana** — O momento em que a maioria das pessoas realmente pinta a casa.

### FAQ

**Quanto rende uma lata de tinta de 18 litros?**
...
# 4. IMPERMEABILIZANTES — `/impermeabilizantes`

**Title (54):** `Impermeabilizantes em Aparecida de Goiânia | Progresso`
**Meta description (148):** `Manta asfáltica, argamassa polimérica, impermeabilizante acrílico e selantes em Aparecida de Goiânia. Loja física no Jardim Nova Era.`
**H1:** Impermeabilizantes em Aparecida de Goiânia
**Keyword principal:** impermeabilizante aparecida de goiânia

**Hero subtítulo:** Manta, argamassa polimérica, aditivo e selante para laje, box, caixa d'água e fundação.

**Mensagem do WhatsApp:** `Olá! Preciso de impermeabilizante para:`
...
**Produto certo para cada aplicação** — Laje, box, piscina e fundação não usam o mesmo material. Explicamos a diferença antes da compra.
**Sistema completo** — Primer, impermeabilizante, tela e proteção mecânica na mesma lista.
**Clima de Goiás no cálculo** — Laje exposta a sol forte e chuva concentrada exige produto com resistência a variação térmica.
...
**Argamassa polimérica serve para box de banheiro?**
...
**Quanto tempo antes do revestimento posso aplicar?**
...
**Correlatas:** Tintas e Pintura · Cimento e Argamassas

---

# 5. METAIS E LOUÇAS SANITÁRIAS — `/metais-e-loucas-sanitarias`

**Title (57):** `Metais e Louças Sanitárias em Aparecida de Goiânia`
**Meta description (150):** `Vaso sanitário, cuba, torneira, chuveiro e acabamentos em Aparecida de Goiânia. Loja física no Jardim Nova Era, aberta inclusive aos domingos.`
**H1:** Metais e louças sanitárias em Aparecida de Goiânia
**Keyword principal:** metais e louças sanitárias aparecida de goiânia

**Hero subtítulo:** Vasos, cubas, tanques, torneiras, chuveiros e acabamentos para banheiro e cozinha.

**Mensagem do WhatsApp:** `Olá! Preciso de metais/louças. Estou procurando:`
...
**Louça e hidráulica na mesma compra** — O engate, o sifão e a válvula saem junto com a peça.
**Peça de reposição** — Reparo de descarga, vedação e acabamento você resolve no balcão.
**Aberto todos os dias** — Inclusive domingo pela manhã.

### FAQ

**Vocês vendem vaso sanitário com caixa acoplada?**
Sim, trabalhamos com vasos com caixa acoplada e modelos convencionais. Consulte cores e modelos disponíveis pelo WhatsApp.

**Tem peça de reposição para descarga?**
...
**A loja tem acabamento de registro avulso?**
Sim, trabalhamos com acabamentos de registro avulsos em diferentes padrões e acabamentos. `[CONFIRMAR: quais marcas/linhas]`

**Correlatas:** Material Hidráulico · Portas e Janelas

---

# 6. FERRAMENTAS — `/ferramentas`

**Title (55):** `Loja de Ferramentas em Aparecida de Goiânia | Progresso`
**Meta description (147):** `Furadeira, esmerilhadeira, martelo, alicate, trena e EPI em Aparecida de Goiânia. Ferramentas manuais e elétricas no Jardim Nova Era.`
**H1:** Ferramentas em Aparecida de Goiânia
**Keyword principal:** loja de ferramentas aparecida de goiânia

**Hero subtítulo:** Ferramentas manuais, elétricas e equipamentos de proteção para obra e manutenção.

**Mensagem do WhatsApp:** `Olá! Preciso de ferramenta. Estou procurando:`
...
**Ferramenta e material juntos** — Broca, parafuso e bucha na medida certa, na mesma compra.
**Linha profissional e doméstica** — Do uso diário em obra ao reparo de fim de semana.
**Aberto no fim de semana** — Sábado e domingo de manhã, quando o serviço em casa acontece.

### FAQ

**Vocês vendem ferramentas elétricas?**
Sim, trabalhamos com furadeiras, parafusadeiras, esmerilhadeiras, serras e martelete. `[CONFIRMAR: marcas trabalhadas]`

**Tem EPI para obra?**
Sim. Trabalhamos com luvas, óculos de proteção, capacete, máscara, protetor auricular e botina de segurança.

**Vocês alugam ferramentas?**
`[CONFIRMAR: a loja faz locação de ferramentas? Se sim, é diferencial forte e merece destaque no hero. Se não, remover a pergunta.]`

**Correlatas:** Ferragens · Material Elétrico

---

# 7. FERRAGENS — `/ferragens`

**Title (50):** `Ferragista em Aparecida de Goiânia | Progresso`
**Meta description (149):** `Parafusos, buchas, pregos, dobradiças, fechaduras e cadeados em Aparecida de Goiânia. Ferragista completa no Jardim Nova Era, aberta todo dia.`
**H1:** Ferragista completa em Aparecida de Goiânia
**Keyword principal:** ferragista aparecida de goiânia

**Hero subtítulo:** Parafuso, bucha, dobradiça, fechadura e cadeado. A peça pequena que trava a obra inteira.

**Mensagem do WhatsApp:** `Olá! Preciso de ferragens. Estou procurando:`
...
- Telas, arames e alambrados `[CONFIRMAR]`

### Diferenciais

**Variedade de medidas** — A bitola exata que a peça pede, não a aproximada.
**Identificação pela foto** — Mande a imagem do parafuso ou da dobradiça no WhatsApp que localizamos o item.
**Ferragem e ferramenta juntas** — Sai com o parafuso, a bucha e a broca do diâmetro certo.

### FAQ

**Vocês vendem parafuso avulso ou só em caixa?**
`[CONFIRMAR: vende por unidade, por quilo ou só em embalagem fechada? Essa é uma das perguntas mais frequentes em ferragista e merece resposta clara.]`

**Como sei qual bucha usar?**
...
**Tem fechadura para porta de banheiro?**
...
# 8. AREIA E BRITA ENSACADA — `/areia-e-brita-ensacada`

**Title (52):** `Areia e Brita Ensacada em Aparecida de Goiânia`
**Meta description (148):** `Areia, brita, pedrisco e pó de pedra ensacados em Aparecida de Goiânia. Compre a quantidade que a obra precisa, no Jardim Nova Era.`
**H1:** Areia e brita ensacada em Aparecida de Goiânia
**Keyword principal:** areia e brita ensacada aparecida de goiânia

**Hero subtítulo:** Agregados em saco, para quem precisa da quantidade certa sem caçamba na porta de casa.

**Mensagem do WhatsApp:** `Olá! Preciso de areia/brita ensacada. Quantidade:`
...
- Pedrisco
- Pó de pedra
- `[CONFIRMAR: peso dos sacos — 20kg? 25kg? Informar o peso é essencial para o cliente calcular quantos sacos comprar.]`
- `[CONFIRMAR: a loja também vende a granel / faz entrega de caçamba? Se sim, é conteúdo relevante e merece seção própria.]`

### Diferenciais

**Compre só o que vai usar** — Sem sobra na calçada, sem desperdício, sem caçamba.
**Leva no carro** — Saco fechado transporta limpo, sem sujar o porta-malas.
**Traço completo na mesma compra** — Areia, brita, cimento e argamassa saem juntos.

### FAQ

**Quantos sacos de areia preciso para 1 m³?**
Depende do peso do saco. `[CONFIRMAR peso do saco para completar esta resposta com o cálculo exato — é uma pergunta de altíssimo volume de busca e a resposta correta pode render posição zero no Google.]`

**Qual a diferença entre areia fina, média e grossa?**
...
**Vocês entregam?**
`[CONFIRMAR: entrega, raio e valor do frete. Para agregados, esta é a pergunta decisiva de compra — o peso torna o transporte próprio inviável acima de certa quantidade.]`

**Correlatas:** Cimento e Argamassas · Ferramentas

---

# 9. CIMENTO E ARGAMASSAS — `/cimento-e-argamassa`

**Title (54):** `Cimento e Argamassa em Aparecida de Goiânia | Progresso`
**Meta description (147):** `Cimento, argamassa colante AC-I, AC-II e AC-III, rejunte e cal em Aparecida de Goiânia. Loja física no Jardim Nova Era. Consulte o preço no WhatsApp.`
**H1:** Cimento e argamassas em Aparecida de Goiânia
**Keyword principal:** cimento aparecida de goiânia

**Hero subtítulo:** Cimento, argamassa colante, rejunte, cal e gesso para toda etapa da obra.

**Mensagem do WhatsApp:** `Olá! Quero saber o preço do cimento/argamassa. Preciso de:`
...
- Cimento CP II e CP `[CONFIRMAR: tipos trabalhados]`, saco de 50kg
...
- `[CONFIRMAR: marcas de cimento trabalhadas — marca é keyword de alto volume de busca]`

### Diferenciais

**Argamassa certa para cada revestimento** — Cerâmica, porcelanato e fachada pedem AC diferente. Orientamos antes da compra.
**Consulta de preço rápida** — Cimento é compra por preço. Mande a quantidade no WhatsApp e receba o valor.
**Agregado no mesmo lugar** — Areia e brita ensacada saem junto para fechar o traço.

### FAQ

**Qual a diferença entre argamassa AC-I, AC-II e AC-III?**
...
**Quanto rende um saco de argamassa colante de 20kg?**
...
**Qual o preço do saco de cimento?**
...
**Vocês vendem para construtora, em volume maior?**
`[CONFIRMAR: atende obra/construtora? Há condição diferenciada por volume? Vende faturado?]`

**Correlatas:** Areia e Brita Ensacada · Impermeabilizantes

---

# 10. PORTAS E JANELAS — `/portas-e-janelas`

**Title (53):** `Portas e Janelas em Aparecida de Goiânia | Progresso`
**Meta description (146):** `Portas de madeira, batentes, janelas de alumínio e guarnições em Aparecida de Goiânia. Loja física no Jardim Nova Era, aberta inclusive aos domingos.`
**H1:** Portas e janelas em Aparecida de Goiânia
**Keyword principal:** portas e janelas aparecida de goiânia

**Hero subtítulo:** Portas, batentes, janelas e todas as ferragens de instalação, na mesma loja.

**Mensagem do WhatsApp:** `Olá! Preciso de porta/janela. Medida e tipo:`
...
- Portas de alumínio `[CONFIRMAR]`
- Fechaduras, dobradiças e puxadores
- Contramarcos e acessórios de instalação
- `[CONFIRMAR: trabalha com esquadrias de PVC? De aço? Faz sob medida ou encomenda?]`

### Diferenciais

**Porta e ferragem no mesmo lugar** — Fechadura, dobradiça e batente saem junto com a folha.
**Conferência de medida antes da compra** — Mande a medida do vão pelo WhatsApp e evite a viagem perdida.
**Acabamento completo** — Guarnição, massa e tinta para finalizar o serviço.

### FAQ

**Como meço o vão para comprar uma porta?**
...
**Vocês vendem porta com batente e fechadura já montados?**
`[CONFIRMAR: trabalha com kit porta pronta? É um item de alta procura e busca própria.]`

**Fazem porta ou janela sob medida?**
`[CONFIRMAR: aceita encomenda fora do padrão? Qual o prazo?]`
...
**Coluna 1 — Progresso Materiais de Construção**
Loja completa de material de construção em Aparecida de Goiânia. Elétrica, hidráulica, tintas, ferragens, cimento e ferramentas.

**Coluna 2 — Categorias**
*(links para as 10 páginas)*

**Coluna 3 — Contato**
Av. Graça Aranha — Jardim Nova Era
Aparecida de Goiânia - GO, 74916-379
(62) 98517-2398
WhatsApp
...
**Linha final:**
© {ano} Progresso Materiais de Construção · `[CONFIRMAR: razão social e CNPJ]` · Política de Privacidade

## Formulário de orçamento

**Título:** Peça seu orçamento
**Apoio:** Preencha os campos e retornamos com preço e disponibilidade.

| Campo | Label | Placeholder |
|---|---|---|
| Nome | Seu nome | — |
| WhatsApp | Seu WhatsApp | (62) 90000-0000 |
| Mensagem | O que você precisa? | Liste os materiais ou descreva o serviço |

**Botão:** Enviar pedido de orçamento
**Nota:** Ao enviar, você concorda com nossa Política de Privacidade.

**Mensagem de erro (campo vazio):** Preencha seu nome para continuarmos.
**Mensagem de erro (WhatsApp inválido):** Confira o número — precisa ter DDD e 9 dígitos.
**Página de sucesso (`/obrigado`):**
Pedido recebido. Respondemos no seu WhatsApp em breve, dentro do horário de funcionamento da loja.
*(Com botão: Falar agora no WhatsApp)*

## Página 404

**H1:** Essa página não existe
Mas o material provavelmente está na loja. Veja as categorias abaixo ou chame no WhatsApp.
*(Grid com as 10 categorias)*

## Botão flutuante de WhatsApp

`aria-label`: "Falar no WhatsApp"
Mensagem padrão: `Olá! Vim pelo site e gostaria de fazer um orçamento.`
