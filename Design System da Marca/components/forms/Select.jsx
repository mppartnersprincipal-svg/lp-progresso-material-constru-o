...
const focusStyle={borderColor:'var(--accent)',boxShadow:'0 0 0 3px var(--focus-ring)'};
  return React.createElement('select',{onFocus:()=>setFocus(true),onBlur:()=>setFocus(false),
    style:{...base,...(focus?focusStyle:{}),...(invalid?{borderColor:'var(--danger)'}:{}),appearance:'auto',...style},...rest},
